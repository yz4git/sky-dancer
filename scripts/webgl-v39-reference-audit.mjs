...
if (!visual.terrainVisible) throw new Error(`V36 faceted terrain is not visible: ${JSON.stringify(visual)}`);
...
await writeFile(`${outputDir}/v39-reference-fidelity-diagnostics.json`, JSON.stringify({ visual, hudVisible, consoleErrors, pageErrors }, null, 2));
