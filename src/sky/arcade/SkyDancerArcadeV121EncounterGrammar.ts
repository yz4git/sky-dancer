...
const STAGE_GRAMMARS: Record<SkyDancerArcadeStageId, StageGrammarProfile> = {
  "dawn-city": {
    labels: ["SKYLINE KNIFE", "GANTRY PINCER"], intents: ["PROBE · CROSSCUT · ACE FINISH", "BAIT · GATE CROSS · OVERTAKE"],
    formations: [["vee", "cross", "pincer"], ["line", "wall", "cross"]], maneuvers: [["approach", "cross-pass", "overtake"], ["close-bank", "parallel", "cross-pass"]],
    enemyBias: ["fighter", "interceptor", "ace"],
  },
  "red-canyon": {
    labels: ["RIDGE HOOK", "KNIFE PASS"], intents: ["LOW ENTRY · ROCK CROSS · CLIMB OUT", "BAIT · PINCER · CLOSE BANK"],
    formations: [["line", "pincer", "vee"], ["vee", "cross", "pincer"]], maneuvers: [["approach", "cross-pass", "close-bank"], ["parallel", "close-bank", "overtake"]],
    enemyBias: ["fighter", "interceptor", "bomber"],
  },
  "cloud-fleet": {
    labels: ["ESCORT BREAK", "DECK CROSS"], intents: ["SCREEN · BROADSIDE · HUNTER CUT", "BAIT · PARALLEL · CROSS DECK"],
    formations: [["wall", "line", "pincer"], ["vee", "wall", "cross"]], maneuvers: [["parallel", "cross-pass", "overtake"], ["approach", "parallel", "cross-pass"]],
    enemyBias: ["missile-boat", "fighter", "interceptor"],
  },
  "storm-carrier": {
    labels: ["THUNDER BOX", "LIGHTNING RUN"], intents: ["PROBE · WALL · ESCAPE LANE", "CROSS · JAM · CLOSE BANK"],
    formations: [["cross", "wall", "vee"], ["pincer", "cross", "line"]], maneuvers: [["approach", "parallel", "cross-pass"], ["cross-pass", "parallel", "close-bank"]],
    enemyBias: ["missile-boat", "interceptor", "bomber"],
  },
  "desert-fortress": {
    labels: ["WALL BREACH", "SAND PINCER"], intents: ["SCREEN · BREACH · HEAVY EXIT", "BAIT · PINCER · BREAK LINE"],
    formations: [["wall", "line", "pincer"], ["vee", "pincer", "wall"]], maneuvers: [["parallel", "approach", "close-bank"], ["approach", "cross-pass", "parallel"]],
    enemyBias: ["bomber", "missile-boat", "fighter"],
  },
  "ice-cavern": {
    labels: ["CRYSTAL SLALOM", "ICE CROSS"], intents: ["THREAD · CROSS · SNAP EXIT", "PROBE · SPIRAL · CLOSE BANK"],
    formations: [["vee", "cross", "line"], ["spiral", "cross", "pincer"]], maneuvers: [["approach", "cross-pass", "overtake"], ["close-bank", "cross-pass", "close-bank"]],
    enemyBias: ["fighter", "interceptor", "ace"],
  },
  "floating-ruins": {
    labels: ["RUIN WEAVE", "PORTAL TRAP"], intents: ["WEAVE · CROSS · GUARDIAN CUT", "BAIT · WALL · PORTAL EXIT"],
    formations: [["spiral", "cross", "vee"], ["line", "wall", "pincer"]], maneuvers: [["close-bank", "cross-pass", "overtake"], ["approach", "parallel", "cross-pass"]],
    enemyBias: ["ace", "interceptor", "missile-boat"],
  },
  "night-metro": {
    labels: ["NEON CROSS", "TUNNEL KNIFE"], intents: ["CHASE · CROSS · PHANTOM EXIT", "BAIT · WALL · OVERTAKE"],
    formations: [["cross", "pincer", "vee"], ["line", "wall", "cross"]], maneuvers: [["overtake", "cross-pass", "close-bank"], ["approach", "parallel", "overtake"]],
    enemyBias: ["interceptor", "ace", "fighter"],
  },
  "volcano-core": {
    labels: ["MAGMA SPIRAL", "CORE PRESS"], intents: ["SPIRAL · CROSS · BREAK OUT", "SCREEN · PRESS · CLOSE BANK"],
    formations: [["spiral", "cross", "pincer"], ["wall", "vee", "cross"]], maneuvers: [["approach", "cross-pass", "overtake"], ["parallel", "close-bank", "cross-pass"]],
    enemyBias: ["bomber", "interceptor", "ace"],
  },
  "orbital-ascent": {
    labels: ["ORBITAL CROSS", "DEBRIS LANCE"], intents: ["PARALLEL · CROSS · HIGH EXIT", "PROBE · LANCE · OVERTAKE"],
    formations: [["cross", "line", "vee"], ["vee", "pincer", "cross"]], maneuvers: [["parallel", "cross-pass", "overtake"], ["approach", "close-bank", "overtake"]],
    enemyBias: ["interceptor", "missile-boat", "ace"],
  },
  "prism-citadel": {
    labels: ["PRISM GAUNTLET", "SOVEREIGN KNIFE"], intents: ["WALL · CROSS · FINAL CUT", "BAIT · SPIRAL · ACE EXIT"],
    formations: [["wall", "cross", "pincer"], ["vee", "spiral", "cross"]], maneuvers: [["parallel", "cross-pass", "close-bank"], ["approach", "close-bank", "overtake"]],
...
export function skyDancerArcadeV121EncounterGrammar(
  ...
  const modeOffset = mode === "armor-screen" ? 1
    : mode === "hunter-sweep" ? 3
      : mode === "jammer-net" ? 5
  ...
  if (mode === "relief-window") {
    return {
      id: `${stageId}-${variant}-relief`, label: "OPEN SKY", intent: "LIGHT PASS · EXIT LANE", signature: `${stageId}:relief:${variant}`, cadenceScale: 1.24,
      phases: [
  ...
  if (mode === "showcase-break") {
    return {
      id: `${stageId}-${variant}-showcase`,
      label: `${label} · SHOWCASE`,
      intent: "SLIPSTREAM · KNIFE CROSS · HERO EXIT",
      signature: `${stageId}:showcase:${variant}`,
      cadenceScale: .78,
      phases: [
        phase("slipstream", "SLIPSTREAM", 0, .50, formations[0], "overtake", maneuvers[0], ["interceptor", "fighter", ...profile.enemyBias], 7),
        phase("knife-cross", "KNIFE CROSS", .58, .52, formations[1], "cross-pass", "close-bank", ["interceptor", "ace", ...profile.enemyBias], -3, pressureBias),
        phase("close-bank", "CLOSE BANK", 1.16, .46, formations[2], "close-bank", "parallel", ["ace", "interceptor", ...profile.enemyBias], -6),
        phase("hero-exit", "HERO EXIT", 1.74, .42, formations[0], "overtake", "cross-pass", ["ace", "interceptor"], -8),
      ],
    };
  }
  ...
  if (mode === "climax-push") {
    return {
      id: `${stageId}-${variant}-climax`,
      label: "CLIMAX PUSH",
      intent: "SCREEN · CROSSCUT · CENTER BREAK · REVEAL",
      signature: `${stageId}:climax:${variant}`,
      cadenceScale: .72,
      phases: [
        phase("screen", "HEAVY SCREEN", 0, .58, "wall", "parallel", "cross-pass", ["missile-boat", "bomber", ...profile.enemyBias], 2, pressureBias),
        phase("crosscut", "ACE CROSSCUT", .54, .54, formations[1], "cross-pass", "close-bank", ["ace", "interceptor"], -4, pressureBias),
        phase("center-break", "CENTER BREAK", 1.08, .50, "pincer", "close-bank", "parallel", ["ace", "missile-boat", ...profile.enemyBias], -6),
        phase("reveal", "CLIMAX REVEAL", 1.64, .38, formations[2], "overtake", "cross-pass", ["ace", "interceptor"], -9),
      ],
    };
  }
  ...
  if (mode === "armor-screen") {
    return {
      id: `${stageId}-${variant}-armor`, label, intent, signature: `${stageId}:armor:${variant}`, cadenceScale: .98,
      phases: [
  ...
  if (mode === "hunter-sweep") {
    return {
      id: `${stageId}-${variant}-hunter`, label, intent, signature: `${stageId}:hunter:${variant}`, cadenceScale: .94,
      phases: [
  ...
  if (mode === "jammer-net") {
    return {
      id: `${stageId}-${variant}-jammer`, label, intent, signature: `${stageId}:jammer:${variant}`, cadenceScale: .97,
      phases: [
  ...
  return {
    id: `${stageId}-${variant}-mixed`, label, intent, signature: `${stageId}:mixed:${variant}`, cadenceScale: 1,
    phases: [
