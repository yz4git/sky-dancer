...
function materials(stage: SkyDancerArcadeStageDefinition, kind: SkyDancerArcadeEnemyKind): Materials {
...
function createRoundBeaconsV18(
  span: number,
  rearZ: number,
  wingColor: number,
  tailColor: number,
...
export function createSkyDancerArcadeEnemyAirframeV18(
  ...
  group.add(createRoundBeaconsV18(built.span, built.rearZ, colorIdentityV29.secondary, colorIdentityV29.glow));
