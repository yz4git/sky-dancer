...
test("Arcade scoring stage missions reward score, signature play and no-damage separately",()=>{
...
test("Arcade scoring breakdown is exact and rewards dangerous routes",()=>{
  const medals=skyDancerArcadeV11StageMedals("dawn-city",{score:13000,destroyed:7,nearMisses:2,multiLockKills:0,turboSmashes:0,bestChain:4,armorBreaks:0,formationBreaks:0,noDamage:true});
...
test("Arcade scoring runtime stage result carries medals and an exact score ledger",()=>{
...
test("Arcade scoring progress persists unique medals and recent route history without breaking v2 saves",()=>{
